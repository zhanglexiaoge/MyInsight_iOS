...
static const CGSize MI_itemSize_ = {140, 140};
...
- (id<MILineFlowLayoutDelegate>)delegate {
    return (id<MILineFlowLayoutDelegate>)self.collectionView.dataSource;
}
