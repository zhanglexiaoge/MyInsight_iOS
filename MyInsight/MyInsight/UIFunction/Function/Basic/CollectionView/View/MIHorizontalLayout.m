...
static const NSInteger MI_Lines_ = 3;
static const CGFloat MI_XMargin_ = 10;
static const CGFloat MI_YMargin_ = 10;
static const UIEdgeInsets MI_EdgeInsets_ = {10, 10, 10, 10};

@interface MIHorizontalLayout()
...
@implementation MIHorizontalLayout
...
- (UIEdgeInsets)edgeInsets {
    if([self.delegate respondsToSelector:@selector(waterflowLayout:edgeInsetsInCollectionView:)]) {
        ...
        return MI_EdgeInsets_;
    }
}

- (id<MIHorizontalLayoutDelegate>)delegate {
    return (id<MIHorizontalLayoutDelegate>)self.collectionView.dataSource;
}
