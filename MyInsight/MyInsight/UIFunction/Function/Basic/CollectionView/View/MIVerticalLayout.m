...
@implementation MIVerticalLayout
...
- (id<MIVerticalLayoutDelegate>)delegate {
    return (id<MIVerticalLayoutDelegate>)self.collectionView.dataSource;
}
