...
- (UIColor *)colorFormaldehydeLevel:(float)value{
    ...
    if (value >=0.00 & value <=0.05) {
        return [BLETool colorWithHexString:@"#75c349"];
    }else if (value > 0.05 & value<= 0.1){
        return [BLETool colorWithHexString:@"#f1bb33"];
    }else if (value >0.1 & value <=0.3){
        return [BLETool colorWithHexString:@"#ff9c50"];
    }else if (value > 0.3 & value <= 0.8){
        return [BLETool colorWithHexString:@"#f27649"];
    }else if (value >0.8 & value <= 1.0){
        return [BLETool colorWithHexString:@"#4f0039"];
    }else{
        return [BLETool colorWithHexString:@"#ff1717"];
...
- (UIColor *) colorWithStr:(NSUInteger ) value{
    ...
    if (value >= 0 & value<= 50) {
        ...
        return [BLETool colorWithHexString:@"#ab3f56"];
        
    }else if (value >= 301 & value <= 500){
        return [BLETool colorWithHexString:@"#7c1b39"];
...
- (NSMutableArray *) handleTheBLEFirstData:(NSMutableArray *)dataArr{
    ...
    NSString *str1 = [BLETool handStrtoulStr1:dataArr[4] andStr2:dataArr[5]];
    NSString *str2 = [BLETool handStrtoulStr1:dataArr[6] andStr2:dataArr[7]];
    NSString *str3 = [BLETool handStrtoulStr1:dataArr[8] andStr2:dataArr[9]];
    NSString *str4 = [BLETool handStrtoulStr1:dataArr[10] andStr2:dataArr[11]];
    NSString *str5 = [BLETool handStrtoulStr1:dataArr[12] andStr2:dataArr[13]];
    NSString *str6 = [BLETool handStrtoulStr1:dataArr[14] andStr2:dataArr[15]];
    
    NSUInteger pm2V = [[BLETool alloc] conversionPM2USAValue:str5];
    NSUInteger pm10V = [[BLETool alloc] conversionPM10USAValue:str6];
    NSUInteger pm2VC = [[BLETool alloc] conversionPM2ChinaValue:str5];
    NSUInteger pm10VC = [[BLETool alloc] conversionPM10ChinaValue:str6];
...
- (NSMutableArray *) handleTheBLETWOData:(NSMutableArray *)dataArr{
    ...
    NSString *jia = [BLETool handStrtoulStr1:dataArr[8] andStr2:dataArr[9]];
    
    NSString * humidity = [BLETool handStrtoulStr1:dataArr[10] andStr2:dataArr[11]];
    NSString * tempdity = [BLETool handStrtoulStr1:dataArr[12] andStr2:dataArr[13]];
